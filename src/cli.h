...
enum secdat_command_type {
    ...
    SECDAT_COMMAND_LIST,
    SECDAT_COMMAND_ATTR,
    SECDAT_COMMAND_META_GET,
    SECDAT_COMMAND_META_SET,
    SECDAT_COMMAND_META_UNSET,
    SECDAT_COMMAND_META_SEARCH,
    SECDAT_COMMAND_META_MARK_LEAKED,
    SECDAT_COMMAND_RELATION_SET,
    SECDAT_COMMAND_RELATION_LS,
    SECDAT_COMMAND_RELATION_SEARCH,
    SECDAT_COMMAND_RELATION_SUGGEST_REFRESH,
    SECDAT_COMMAND_RELATION_SUGGEST_LINK,
    SECDAT_COMMAND_RELATION_SHOW,
    SECDAT_COMMAND_RELATION_RM,
    SECDAT_COMMAND_FSCK,
    SECDAT_COMMAND_GC,
    SECDAT_COMMAND_MASK,

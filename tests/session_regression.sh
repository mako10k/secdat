...
for args, marker in [
    ...
    ([bin_path, "help", "exec"], "[--inject LAYER:KIND=SELECTOR]... [-p GLOBPATTERN|--pattern GLOBPATTERN] [-x GLOBPATTERN|--pattern-exclude GLOBPATTERN] [--env-map-sed EXPR] [--sandbox-injectable] [--require-key KEY] [--dry-run] [--json] [--json-summary] [--] CMD [ARGS...]"),

...
for args, marker in [
    ...
    ([bin_path, "help", "list"], "list [-m|--masked] [-o|--overridden] [-O|--orphaned] [-e|--safe|--secret-value] [-u|--unsafe|--public-value] [--inject-bulk-gate]"),
    ([bin_path, "help", "attr"], "attr KEYREF [--key-visibility always|unlocked] [--value-access unlocked|always] [--inject-bulk exclude|named|include]"),
    ...
    ([bin_path, "help", "ls"], "[-x GLOBPATTERN|--pattern-exclude GLOBPATTERN] [-e|--safe|--secret-value] [-u|--unsafe|--public-value] [--metadata] [--inject-bulk-gate]"),
...
for args, fragments in [
    ...
    (
        ...
        [
            ...
            "inject_bulk controls bulk-gated export/exec eligibility",
            "--inject-bulk-gate is used",
            "secret object's inject_bulk_value policy",
        ],
    ),
    (
        [bin_path, "help", "fsck"],

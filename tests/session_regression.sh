...
for args, marker in [
    ...
    ([bin_path, "help", "gc"], "gc [--orphaned] [--dangling] [--queued] [--dry-run] [--format v2]"),
    ...
    ([bin_path, "help", "ls"], "[-x GLOBPATTERN|--pattern-exclude GLOBPATTERN] [-e|--safe|--secret-value] [-u|--unsafe|--public-value] [--metadata] [--bulk-gate]"),
    ...
    ([bin_path, "help", "secret"], "secret status [--gc] UUID"),
    ([bin_path, "help", "secret", "status"], "secret status [--gc] UUID"),
    ([bin_path, "--help", "secret", "status"], "secret status [--gc] UUID"),
    ([bin_path, "secret", "status", "--help"], "secret status [--gc] UUID"),
